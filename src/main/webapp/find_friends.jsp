<%-- 
    Document   : find_friends
    Created on : Dec 3, 2015, 1:29:01 PM
    Author     : Pasxalis
--%>
...
<html lang="en">
    <head>
        ...
        <title>SnapiChat | Find Friends</title>
    ...
    <body>
        ...
        <div id="friends" class="container spacer ">
            <h3 class="text-center  wowload fadeInUp">People</h3>
            <p class="text-center  wowload fadeInLeft">Found ${friends.size()} possible friends</p>
            <div class="row grid team  wowload fadeInUpBig">
                <c:choose>
                    <c:when test="${friends.size() > 0}">
                        <c:forEach items="${friends}" var="friend">
                            <div class=" col-sm-3 col-xs-6 friend-box">
                                ...
                                <form action="makeFriend" method="POST">
                                    <input type="hidden" name="friend-name" value="${friend.username}">
                                    <input class="btn btn-primary" type="submit" value="Add ${friend.username}">
                                </form>
                            </div>
                        </c:forEach>
                    </c:when>
